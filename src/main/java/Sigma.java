...
public class Sigma {
    ...
    //List
    ArrayList<Task> list;
    private void showList() throws SigmaException, IOException {
        line();
        if (list.size() == 0) {
    ...
    private void addToDo(String[] tokens) throws SigmaException, IOException {
        line();
    ...
    private void addDeadline(String[] tokens) throws SigmaException, IOException {
        line();
    ...
    private void addEvent(String[] tokens) throws SigmaException, IOException {
        line();
    ...
    private void markDone(int i) throws SigmaException, IOException {
        try {
    ...
    private void markUndone(int i) throws SigmaException, IOException {
        try {
            Task todo = list.get(i - 1);
            todo.setDone(false);
            line();
    ...
    private void deleteTask(int i) throws SigmaException, IOException {
        try {
    ...
    private void awaitReply() throws SigmaException, IOException {
    ...
    private void start() throws SigmaException, IOException {
        greet();
        awaitReply();
    }
